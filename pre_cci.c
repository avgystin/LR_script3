# 1 "c:\\users\\ura\\desktop\\lr_scripts\\script3\\\\combined_script3.c"
...
# 1 "c:\\users\\ura\\desktop\\lr_scripts\\script3\\\\combined_script3.c" 2
...
# 2 "c:\\users\\ura\\desktop\\lr_scripts\\script3\\\\combined_script3.c" 2
...
# 3 "c:\\users\\ura\\desktop\\lr_scripts\\script3\\\\combined_script3.c" 2
...
# 4 "c:\\users\\ura\\desktop\\lr_scripts\\script3\\\\combined_script3.c" 2
...
action()
{
	...
	lr_end_transaction("script3_start_T001", 2);
	...
	{
		lr_end_transaction("script3_login_T002", 2);
	}
	else
	{
		lr_end_transaction("script3_login_T002", 1);
	}
	...
	{
		lr_end_transaction("script3_animal_T003", 2);
	}
	else
	{
		lr_end_transaction("script3_animal_T003", 1);
	}
	...
	{
		lr_end_transaction("script3_bulldog_T004", 2);
	}
	else
	{
		lr_end_transaction("script3_bulldog_T004", 1);
	}
	...
	{
		lr_end_transaction("script3_MaleAdultBulldog_T005", 2);
	}
	else
	{
		lr_end_transaction("script3_MaleAdultBulldog_T005", 1);
	}
	...
	{
		lr_end_transaction("script3_AddToCart_T006", 2);
	}
	else
	{
		lr_end_transaction("script3_AddToCart_T006", 1);
	}
	...
	{
		lr_end_transaction("script3_ProceedToCheckout_T007", 2);
	}
	else
	{
		lr_end_transaction("script3_ProceedToCheckout_T007", 1);
	}
	...
	{
		lr_end_transaction("script3_Continue_T008", 2);
	}
	else
	{
		lr_end_transaction("script3_Continue_T008", 1);
	}
	...
	{
		lr_end_transaction("script_Confirm_T009", 2);
	}
	else
	{
		lr_end_transaction("script_Confirm_T009", 1);
	}
...
# 5 "c:\\users\\ura\\desktop\\lr_scripts\\script3\\\\combined_script3.c" 2
...
# 6 "c:\\users\\ura\\desktop\\lr_scripts\\script3\\\\combined_script3.c" 2
...
# 7 "c:\\users\\ura\\desktop\\lr_scripts\\script3\\\\combined_script3.c" 2
